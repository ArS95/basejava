                ...
                <c:choose>
                    ...
                    <c:when test="${section.equals(SectionType.EDUCATION) || section.equals(SectionType.EXPERIENCE)}">
                        ...
                        <c:if test="${resume.getSection(section) != null}">
                            ...
                            <dd><input type="text" name="startDate${org}0" size="30" placeholder="MM/yyyy">
                            </dd>
                            <br>
                            <dt>Конечная дата:</dt>
                            <dd><input type="text" name="endDate${org}0" size="30" placeholder="MM/yyyy">
                            </dd>
                            <br>
                            <dt>Должность</dt>
                            <dd><input type="text" name="title${org}0" size="30"></dd>
                            <br>
                            <dt>Описание</dt>
                            <dd><textarea rows="3" cols="32" name="description${org}0"></textarea></dd>
                            <br>
                            <br>
                            ...
                            <c:forEach var="organization" items="${resume.getSection(section).organizations}"
                                ...
                                <dt>Начальная дата:</dt>
                                <dd><input type="text" name="startDate${org}${orgCount.count}0" placeholder="MM/yyyy">
                                </dd>
                                <br>
                                <dt>Конечная дата:</dt>
                                ...
                                <br>
                                <dt>Описание</dt>
                                <dd><textarea rows="3" cols="32" name="description${org}${orgCount.count}0"></textarea>
                                </dd>
                                <br>
                                <br>
                                ...
                                <c:forEach var="position" items="${organization.positions}" varStatus="posCount"
                                    ...
                                    <dd><input type="text" name="startDate${org}${orgCount.count}${posCount.count}"
                                               placeholder="MM/yyyy"
                                               value="<%=position.getStartDate().format(Position.FORMAT)%>">
                                    </dd>
                                    <br>
                                    <dt>Конечная дата:</dt>
                                    <dd><input type="text" name="endDate${org}${orgCount.count}${posCount.count}"
                                               placeholder="MM/yyyy"
                                               value="<%=position.getEndDate().format(Position.FORMAT)%>">
                                    </dd>
                                    <br>
                                    <dt>Должность</dt>
